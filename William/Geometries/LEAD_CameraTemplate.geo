...
<AssetObjects..GeometryInstance>
	...
	<m_Meshes/>
	<m_Bones>
		<Element text="MasterCamera"/>
		<Element text="LeaderCamera"/>
	</m_Bones>
	<m_ModelName text="MasterCamera"/>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_CameraTemplate.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_CameraTemplate.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_CameraTemplate"/>
	<m_Description text="LEAD_CameraTemplate"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
