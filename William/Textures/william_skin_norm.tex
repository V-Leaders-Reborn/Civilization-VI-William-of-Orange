...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Simon\Downloads\William_improved\william_skin_norm.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3000301491</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="william_skin_norm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="william_skin_norm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
