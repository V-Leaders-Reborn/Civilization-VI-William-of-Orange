...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ5Mod\Leaderhead_Work\Expansion1Leaders\resaveBatch\Modbuddy\Textures\william_hair_diff_up.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4049535451</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="william_hair_diff_up.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="william_hair_diff_up"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
